...
{
	bool deep_copy_textures = false;

	WorldObjects* objects_copy = world_objects_deep_copy(world_objects, deep_copy_textures);
	...
	free_world_objects(objects_copy, deep_copy_textures);
}
